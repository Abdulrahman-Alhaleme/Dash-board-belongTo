    ...
    <div className="settings" dir="rtl">
      <div className="settings__wrapper">
        ...
        <div className="settings__top">
          <button className="setting__btn">التفاصيل</button>
          <button className="setting__btn active__btn">الملف الشخصي</button>
          <button className="setting__btn">كلمة السر</button>
          <button className="setting__btn">البريد الألكتروني</button>
          <button className="setting__btn">الأشعارات</button>
        </div>
